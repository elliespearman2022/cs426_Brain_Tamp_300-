...
## Getting Started
If you would like to simply play the game, you can download the [Mac](Final%20Mac%20Build/Brain-Temp 300°) or [Windows](Final%20Windows%20Build/Brain-Temp 300°/B-T300°_PT.exe) versions. If you would like to experiment with the environment we developed the game in, make sure you have **Unity 2019.4.19f1** installed.
